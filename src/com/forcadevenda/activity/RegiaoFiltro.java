...
public class RegiaoFiltro extends GFiltroActivity {
    
    private EditText etNome;  
    
    public static void call(Activity act, int idChamada, ContentValues filtro){
        try{    
            Intent i = new Intent(act, RegiaoFiltro.class);            
    ...
    protected void popularTela(){
        etNome.setText(filtro.getAsString(Regiao.colNome));
    }
    
    @Override
    protected void popularObjeto(){
        filtro.put(Regiao.colNome, etNome.getText().toString());
    }
    ...
    public String toString() {
        String f = "";
        f = GSQL.filtroAnd(f, GSQL.filtroLike(Regiao.colNome, filtro.getAsString(Regiao.colNome)));
