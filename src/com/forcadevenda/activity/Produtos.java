...
public class Produtos extends GListActivity<Produto> {
    
    public static void call(Activity act, int idChamada, boolean isSelecao){
        try{
            Intent i = new Intent(act, Produtos.class);            
	...
	ProdutoForm.call(this, lista.get(getPosicao()).getId()); 
    }        
    ...
    protected void filtrar() {
        ProdutoFiltro.call(this, G.IDFILTRAR, getCtvFiltro());
    }    
    ...
    protected GAdapter adapter() {
        return new ProdutosAdapter(this, lista);
    }
