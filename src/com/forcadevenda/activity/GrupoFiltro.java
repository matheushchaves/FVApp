...
public class GrupoFiltro extends GFiltroActivity {
    
    private EditText etNome;  
    
    public static void call(Activity act, int idChamada, ContentValues filtro){
        try{    
            Intent i = new Intent(act, GrupoFiltro.class);            
    ...
    protected void popularTela(){
        etNome.setText(filtro.getAsString(Grupo.colDescricao));
    }
    
    @Override
    protected void popularObjeto(){
        filtro.put(Grupo.colDescricao, etNome.getText().toString());
    }
    ...
    public String toString() {
        String f = "";
        f = GSQL.filtroAnd(f, GSQL.filtroLike(Grupo.colDescricao, filtro.getAsString(Grupo.colDescricao)));
